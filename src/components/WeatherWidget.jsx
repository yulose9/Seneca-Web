...
import { getSmartWeatherSummary } from '../services/weatherService';
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute top-full right-0 mt-3 w-[300px] bg-white rounded-2xl shadow-xl border border-black/5 overflow-hidden p-4"
                    >
